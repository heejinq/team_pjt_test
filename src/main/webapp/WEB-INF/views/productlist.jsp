            ...
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <div style="text-align: center;">
	                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
	                    ...
	                    <label class="btn btn-outline-Dark" for="btnradio1" style="border-inline-color: #424446;">상의</label>
	                  
	                    <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off">
	                    <label class="btn btn-outline-Dark" for="btnradio2" style="border-inline-color: #424446;">하의</label>
	                  
	                    <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off">
	                    <label class="btn btn-outline-Dark" for="btnradio3" style="border-inline-color: #424446;">신발</label>
	                </div>   
            	</div>
